...
export default function Home() {
  const cards = [
    { title: "🚨 Report a Scam", desc: "Report scam attempts and get instant susceptibility scoring with verified contact matching.", path: "/report", btn: "Report Now" },
